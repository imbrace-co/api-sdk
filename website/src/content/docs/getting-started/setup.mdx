---
title: Setup Guide
description: Install the Imbrace SDK, set up environments, configure credentials, and override service URLs.
---
...
API Key expired or invalid. Generate a new one from the [Imbrace Dashboard](https://cloud.imbrace.co) or see the [API Key guide](/guides/api-key).
