...
- [Authentication →](/sdk/authentication/) — OTP login flow, credential lifecycle, and token storage
- [Error Handling →](/sdk/error-handling/) — how `AuthError`, `ApiError`, and `NetworkError` surface
- [Quick Start →](/sdk/quick-start/) — minimal working example before adding framework wiring
