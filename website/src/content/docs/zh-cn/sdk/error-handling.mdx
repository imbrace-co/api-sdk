---
title: 错误处理
description: 错误类型、自动重试行为以及使用 Imbrace SDK 处理故障的最佳实践。
---

import { Tabs, TabItem } from "@astrojs/starlight/components";

SDK 抛出的所有错误都继承自单个基类型，因此你可以在一处捕获任何 SDK 错误，或者在需要区别处理时按具体子类分别捕获。TypeScript 和 Python SDK 的层次结构相同。
...
# 3. 针对 ApiError 按 status_code 分支处理
try:
