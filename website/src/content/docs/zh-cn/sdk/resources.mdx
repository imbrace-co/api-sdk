---
title: 资源参考
description: Imbrace SDK 按命名空间的参考文档 — 联系人、对话、消息传递、营销活动等。
---

import { Tabs, TabItem } from "@astrojs/starlight/components";

本页涵盖了 SDK 暴露的 CRM 和消息传递命名空间。首先初始化客户端（参见[安装](/zh-cn/sdk/installation/)或[快速入门](/zh-cn/sdk/quick-start/)）。以下所有代码片段假设 `client` 是已初始化的实例。

有关 AI 和工作流相关资源，请参见：
- [AI 代理](/zh-cn/sdk/ai-agent/) — AI 代理（`chatAi`）、AI 代理流式传输、嵌入、parquet
- [工作流](/zh-cn/sdk/workflows/) — 工作流流程和渠道自动化
- [数据面板](/zh-cn/sdk/databoard/) — CRM 管道面板和条目

有关将这些资源结合使用的端到端演练，请参见[完整流程指南](/zh-cn/sdk/full-flow-guide/)。
...
## 消息传递 — `client.channel`, `client.messages`
