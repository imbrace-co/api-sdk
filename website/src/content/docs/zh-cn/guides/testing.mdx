...
> TypeScript 集成测试尚未可用 — 请参见 [`py/tests/integration/`](https://github.com/imbrace-co/api-sdk/tree/main/py/tests/integration) 获取实时 API 检查，或 [`test/test-local-pkg/ts/`](https://github.com/imbrace-co/api-sdk/tree/main/test/test-local-pkg/ts) 获取手动实时测试脚本。
