...
|--------|-----------|--------|------|
| 列出 board | `list` | `list` | 列出所有 board |
| 获取 board | `get` | `get` | 按 ID 获取 board |
| 创建 board | `create` | `create` | 创建新 board |
| 更新 board | `update` | `update` | 更新 board 名称/描述 |
| 删除 board | `delete` | `delete` | 删除 board |
| 重新排序 board | `reorder` | `reorder` | 更改显示顺序 |

### 导入 / 导出

| 方法 | TypeScript | Python | 说明 |
|--------|-----------|--------|------|
| 导出 CSV | `exportCsv` | `export_csv` | 将所有项目导出为 CSV |
| 导入 CSV | `importCsv` | `import_csv` | 从 CSV 文件导入项目 |
| 导入 Excel | `importExcel` | `import_excel` | 从 Excel 文件导入项目 |
...
| 方法 | TypeScript | Python | 说明 |
|--------|-----------|--------|------|
| 创建字段 | `createField` | `create_field` | 向 board 添加列 |
...
| 方法 | TypeScript | Python | 说明 |
|--------|-----------|--------|------|
| 列出项目 | `listItems` | `list_items` | 分页的 board 项目列表 |
| 获取项目 | `getItem` | `get_item` | 获取单个项目 |
| 创建项目 | `createItem` | `create_item` | 向 board 添加项目 |
| 更新项目 | `updateItem` | `update_item` | 更新项目字段值 |
| 删除项目 | `deleteItem` | `delete_item` | 移除项目 |
| 批量删除 | `bulkDeleteItems` | `bulk_delete_items` | 按 ID 删除多个项目 |
| 搜索 | `search` | `search` | 在 board 内进行全文搜索 |
| 链接项目 | `linkItems` | `link_items` | 将项目链接到相关 board 项目 |
| 取消链接项目 | `unlinkItems` | `unlink_items` | 移除项目间的链接 |
