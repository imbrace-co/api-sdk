...
請先初始化用戶端（請參閱[安裝](/sdk/installation/)或[快速入門](/sdk/quick-start/)）。如需將工作流程連接至 AI agent 的端到端逐步說明，請參閱[完整流程指南 §2](/sdk/full-flow-guide/#2-create-a-workflow-and-bind-it-to-an-ai-agent)。
