---
title: 測試指南
description: 為 Imbrace SDK 執行單元測試、整合測試、lint 和型別檢查的完整指南。
---
...
> TypeScript 整合測試尚不可用 — 請參閱 [`py/tests/integration/`](https://github.com/imbrace-co/api-sdk/tree/main/py/tests/integration) 以進行即時 API 檢查，或參閱 [`test/test-local-pkg/ts/`](https://github.com/imbrace-co/api-sdk/tree/main/test/test-local-pkg/ts) 取得手動即時測試腳本。
