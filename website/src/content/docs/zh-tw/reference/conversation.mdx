---
title: 對話
description: client.conversations 的結構與方法參考 — 列出、搜尋、加入、指派和管理對話串。
---

import { Tabs, TabItem } from "@astrojs/starlight/components";

`client.conversations` 管理聯絡人與您的團隊（或 AI 代理）之間的對話串。每個對話屬於一個 [Channel](/reference/channel/) 並連結到一個 [Contact](/reference/contact/)。
