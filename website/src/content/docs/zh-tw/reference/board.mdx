...
| 更新欄位 | `updateField` | `update_field` | 修改欄位配置 |
...
| 建立區隔 | `createSegment` | `create_segment` | 將篩選儲存為區段 |
| 更新區隔 | `updateSegment` | `update_segment` | 更新區段的篩選條件 |
| 刪除區隔 | `deleteSegment` | `delete_segment` | 移除區段 |
