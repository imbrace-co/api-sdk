...
> TypeScript integration tests aren't available yet — see [`py/tests/integration/`](https://github.com/imbraceltd/api-sdk/tree/main/py/tests/integration) for live API checks, or [`test/test-local-pkg/ts/`](https://github.com/imbraceltd/api-sdk/tree/main/test/test-local-pkg/ts) for manual live testing scripts.
