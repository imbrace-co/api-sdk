...
> Integration test cho TypeScript hiện chưa có — xem [`py/tests/integration/`](https://github.com/imbrace-co/api-sdk/tree/main/py/tests/integration) để kiểm tra với API thật, hoặc [`test/test-local-pkg/ts/`](https://github.com/imbrace-co/api-sdk/tree/main/test/test-local-pkg/ts) để có các script kiểm thử thủ công với API thật.
