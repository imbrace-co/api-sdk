...
Tối thiểu cần thiết cho các lời gọi tới API thật:
...
### Cài đặt Wheel (xác minh đúng dạng gói sẽ phát hành)
...
- [Hướng dẫn kiểm thử →](/guides/testing/) — unit test, integration test, lint và kiểm tra kiểu cho mã nguồn SDK
- [Xử lý lỗi →](/sdk/error-handling/) — cách SDK phát sinh lỗi và thử lại
- [Hướng dẫn toàn diện →](/sdk/full-flow-guide/) — các hướng dẫn từ đầu đến cuối mà bài kiểm thử hồi quy mô phỏng lại
