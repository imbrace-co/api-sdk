...
- [Bắt đầu nhanh →](/sdk/quick-start/) — thực hiện lời gọi API đầu tiên trong 60 giây
- [Xác thực →](/sdk/authentication/) — loại thông tin xác thực, luồng đăng nhập OTP và khi nào sử dụng mỗi loại
- [Hướng dẫn thiết lập →](/getting-started/setup/) — môi trường, biến môi trường và ghi đè URL dịch vụ