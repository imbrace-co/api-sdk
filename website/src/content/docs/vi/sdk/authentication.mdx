...
| **Ghi nhận theo người dùng ở phía Imbrace** | Tích hợp sẵn | Tùy bạn |
...
> Cả hai loại thông tin xác thực đều được hỗ trợ đầy đủ như nhau. Hầu hết các resource đều chấp nhận cả hai. Một số tính năng phụ thuộc vào ngữ cảnh người dùng (document artifacts, lịch sử chat theo người dùng) chỉ có ý nghĩa với access token.
...
- [Hướng dẫn thiết lập →](/getting-started/setup/#configure-credentials) — biến môi trường, dotenv và quản lý secrets
- [Bắt đầu nhanh →](/sdk/quick-start/) — lời gọi API đầu tiên với thông tin xác thực của bạn
- [Tích hợp →](/sdk/integrations/) — các mẫu kết nối với framework (React, Next.js, FastAPI, Django)
