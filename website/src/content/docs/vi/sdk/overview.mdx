...
Cùng registry operation này cũng là nền tảng của [MCP server host sẵn trên gateway](/vi/mcp/overview/) và lệnh [`imbrace mcp`](/vi/cli/commands/#mcp-server) trong CLI — cả hai đều mở các operation này thành tool MCP cho AI agent.
