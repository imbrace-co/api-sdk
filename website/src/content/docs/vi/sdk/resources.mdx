...
Trang này bao gồm các namespace CRM và nhắn tin do SDK cung cấp. Khởi tạo client trước (xem [Cài đặt](/sdk/installation/) hoặc [Quick Start](/sdk/quick-start/)). Tất cả các đoạn mã bên dưới đều giả định `client` là instance đã được khởi tạo.
...
## Hội thoại — `client.conversations`
...
// Kiểm tra tính hợp lệ của cấu hình điểm tiếp xúc trước khi lưu
