...
Chat completions tương thích OpenAI có sẵn trên namespace `client.ai` cho cả TypeScript và Python. Xem phần [Dịch vụ AI tương thích OpenAI](#dịch-vụ-ai-tương-thích-openai--clientai) bên dưới để biết chi tiết.
...
Các endpoint REST chat cũ để duy trì lịch sử hội thoại. Có sẵn trên `client.ai_agent` cho cả TypeScript và Python. Xem [Legacy v1 chat](#chat-v1-cũ) bên dưới.
