...
Ngoài các lệnh resource, CLI còn chạy được như một **MCP server** (`imbrace mcp`), mở toàn bộ API Imbrace thành tool cho AI agent — xem [Commands → MCP Server](/vi/cli/commands/#mcp-server).
