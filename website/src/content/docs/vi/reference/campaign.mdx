...
|--------|-----------|--------|-------|
| Danh sách chiến dịch | `list` | `list` | Danh sách tất cả chiến dịch |
| Lấy chiến dịch | `get` | `get` | Lấy chiến dịch theo ID |
| Tạo chiến dịch | `create` | `create` | Tạo chiến dịch mới |
| Xóa chiến dịch | `delete` | `delete` | Xóa chiến dịch |

### Touchpoint

| Phương thức | TypeScript | Python | Mô tả |
|--------|-----------|--------|-------|
| Danh sách touchpoint | `listTouchpoints` | `list_touchpoints` | Danh sách tất cả touchpoints |
| Lấy touchpoint | `getTouchpoint` | `get_touchpoint` | Lấy touchpoint theo ID |
| Tạo touchpoint | `createTouchpoint` | `create_touchpoint` | Thêm touchpoint vào chiến dịch |
| Cập nhật touchpoint | `updateTouchpoint` | `update_touchpoint` | Cập nhật touchpoint |
| Xóa touchpoint | `deleteTouchpoint` | `delete_touchpoint` | Xóa touchpoint |
| Kiểm tra touchpoint | `validateTouchpoint` | `validate_touchpoint` | Kiểm tra tính hợp lệ của cấu hình touchpoint |
