...
Besides resource commands, the CLI can run as an **MCP server** (`imbrace mcp`), exposing the whole Imbrace API as tools for AI agents — see [Commands → MCP Server](/cli/commands/#mcp-server).
